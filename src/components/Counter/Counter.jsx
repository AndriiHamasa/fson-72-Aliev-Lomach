...
const reducer2 = (state, action) => {
  if (action.type === "createName") return { ...state, name: action.payload };
  if (action.type === "setAge") return { ...state, age: action.payload };
...
export const Counter = () => {
  ...
  setUser({
    type: "createAllInfoUser",
    payload: { a: "Alex", b: 30, c: false },
  });
